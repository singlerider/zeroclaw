...
/// modal confirm chord), never hardcoded literals, so vim/emacs/overridden
/// bindings show correctly.
...
mod tests {
    ...
    async fn agent_picker_click_selects_row() {
        ...
        // Stored rect is the draw's shifted form: list_click_index treats
        // (y+1) as the first item. With y=1, first item maps to row 2.
