...
// chord for each action — never a hardcoded glyph. These helpers resolve the
// first display chord for the actions used by the daemon config editor.
...
/// Joined up/down display chords for list navigation footers/help.
fn nav_keys() -> String {
