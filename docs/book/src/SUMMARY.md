...
- [One-click bootstrap](./setup/one-click-bootstrap.md)
- [macOS update & uninstall](./setup/macos-update-uninstall.md)
...
- [Adding boards and tools](./hardware/adding-boards-and-tools.md)
...
- [API (rustdoc)](./api.md)
- [SOP overview](./reference/sop/index.md)
- [SOP cookbook](./reference/sop/cookbook.md)
- [SOP syntax](./reference/sop/syntax.md)
- [SOP connectivity](./reference/sop/connectivity.md)
- [SOP observability](./reference/sop/observability.md)
