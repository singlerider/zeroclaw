...
mod tests {
    ...
    fn load_filters_empty_assistant_responses() {
        ...
        store
            .append("corrupted", &ChatMessage::user("decode this"))
            .unwrap();
        store
            .append("corrupted", &ChatMessage::assistant(""))
            .unwrap();
        store
            .append("corrupted", &ChatMessage::user("hello?"))
            .unwrap();
        store
            .append("corrupted", &ChatMessage::assistant(""))
            .unwrap();
        store
            .append("corrupted", &ChatMessage::user("hey"))
            .unwrap();
