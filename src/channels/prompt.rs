//! System prompt construction for channel-based conversations.
//!
//! Builds the system prompt that frames the agent's behavior when running
//! inside a messaging channel. The prompt includes tool descriptions, safety
//! rules, workspace context, bootstrap files, and runtime metadata.

use crate::identity;
use crate::security::AutonomyLevel;

/// Maximum characters per bootstrap file injected into the prompt.
