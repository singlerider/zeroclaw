...
// Feature-gated re-exports — public API surface for external consumers.
// Many are accessed via direct module paths internally, so re-exports appear unused.
#[cfg(feature = "channel-acp-server")]
#[allow(unused_imports)]
pub use acp_server::{AcpServer, AcpServerConfig};
#[cfg(feature = "channel-bluesky")]
...
#[allow(unused_imports)]
use factory::{
    ConfiguredChannel, ChannelHealthState, build_channel_by_id, classify_health_result,
    collect_configured_channels, send_channel_message,
};
