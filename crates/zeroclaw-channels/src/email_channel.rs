...
pub use zeroclaw_config::schema::EmailConfig;

// Re-export default functions for tests
#[allow(unused_imports)]
pub(crate) use zeroclaw_config::schema::{
    default_imap_port, default_smtp_port, default_imap_folder,
    default_idle_timeout, default_email_tls as default_true,
    default_email_subject, default_max_attachment_bytes,
};
