...
use zeroclaw_config::security_policy::{SecurityPolicy, ToolOperation};
...
impl NotionTool {
    ...
    async fn query_database(
        ...
        if !status.is_success() {
            ...
            let truncated = zeroclaw_channels::util::truncate_with_ellipsis(&text, MAX_ERROR_BODY_CHARS);
...
mod tests {
    use super::*;
    use zeroclaw_config::security_policy::SecurityPolicy;
